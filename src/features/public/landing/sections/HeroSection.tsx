...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90dvh] lg:min-h-[100dvh] pt-32 pb-16 px-4 md:px-8 lg:px-12 flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto w-full relative z-10 flex flex-col items-center">
        ...
        <div className="bg-white/40 backdrop-blur-2xl rounded-3xl lg:rounded-[48px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-200/80 overflow-hidden flex flex-col lg:flex-row w-full p-3 sm:p-4 lg:p-6 gap-4 sm:gap-6 relative group/card">
          ...
          <div className="flex-1 flex flex-col justify-center px-4 py-6 sm:py-8 lg:px-12 lg:py-16 lg:w-[45%] shrink-0 order-2 lg:order-1 relative z-10">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-800 font-medium mb-8 sm:mb-12 leading-relaxed tracking-tight">
          ...
          <div className="relative w-full lg:w-[55%] min-h-[280px] sm:min-h-[350px] lg:min-h-[500px] bg-slate-900 rounded-2xl lg:rounded-[36px] overflow-hidden order-1 lg:order-2 shadow-2xl border-4 lg:border-[6px] border-white/80 ring-1 ring-black/5">
