      ...
      <Marquee speed="slow" className="py-2" showArrows={false}>
        {siteContent.dates.items.map((stat, i) => (
          <div key={i} className="flex items-center shrink-0 group">
            <span className="text-4xl md:text-5xl lg:text-6xl font-sans font-bold text-amber-400 tracking-tight whitespace-nowrap tabular-nums">
              {stat.value}
            </span>
            ...
            <div className="w-px h-16 bg-gradient-to-b from-transparent via-white/20 to-transparent mx-4 md:mx-12"></div>
          </div>
        ))}
      </Marquee>
    </section>
