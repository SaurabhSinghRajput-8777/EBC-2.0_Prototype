  ...
  return (
    <div className={cn("relative mb-16 md:mb-24 flex flex-col", align === "center" ? "items-center text-center" : "items-start text-left", className)}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto w-full">
        <h2 className={cn("font-serif font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight mb-4 md:mb-6 lg:mb-8 leading-tight", titleClassName || "text-[#0A0C10]")}>
          {title}
        </h2>
        {subtitle && (
          <p className={cn("text-base sm:text-lg md:text-xl leading-relaxed max-w-3xl mx-auto", subtitleClassName || "text-[#4A5568]")}>
            {subtitle}
          </p>
        )}
      </div>
